...
{{-- <div class="modal fade" id="chartModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content bg-white position-relative">
      ...
      <div class="p-4">
        <canvas id="modalChartCanvas" style="height: 80vh;"></canvas>
      </div>
    </div>
  </div>
</div> --}}
...
<script>
    ...
    function plotChart(id, label, keys, data, freq, colors) {
        ...
        return chart;  // ritorna il riferimento
    }
...
document.querySelectorAll('.chart-box').forEach(box => {
  box.addEventListener('click', () => {
    ...
    const titleText = (typeof originalTitle === 'string' ? originalTitle : '') + " (Ingrandito)";
